...
<body>
	<%
		List<Order> lists = (List<Order>) session.getAttribute("teacherNowOrder");
	%>
	<style type="text/css">
.box {
	margin: 0px 50px;
		...
		<div class="box row">
			<div class="sbox" style="width: 300px; height: 320px;">
				...
				<table class="index-table"
					style="background-color: white; font-size: 17px; width: 300px;">
					<tr>
						<td>当前预约数:</td>
						<td width="80px">${sessionScope.teaInfoMap.orderNumber }&nbsp;</td>
					</tr>
					<tr>
						<td>历史预约数:</td>
						<td>${sessionScope.teaInfoMap.allOrderNumber }</td>
					</tr>
					<tr>
						<td>管理班级数:</td>
						<td>${sessionScope.teaInfoMap.classNum }</td>
					</tr>
				</table>
			</div>
			<div
			...
			<div class="sbox">
				...
				<table class="index-table"
					...
					<tr>
						...
						<td><%=order.getExperProjectAccount()%></td>
			...
			<div class="sbox" style="width: 300px; height: 200px;">
				<h2 class="stuindextable" style="width: 300px; height: 35px;">公&nbsp;告&nbsp;信&nbsp;息<a id="blink" href="javascript:void(0);"
						onclick="noticePage()" style="float: right">More&nbsp;</a>	</h2>
				<table class="index-table"
					style="padding-left: 0px; background-color: white; width: 300px;">
					<tr>
						<td>标题</td>
						<td>发布日期</td>
					</tr>
							...
							if (data == null || data == '') {
								...
								for (var i = 0; i < data.length; i++) {
									str += "<tr><td><a href='#' style='text-decoration:none; color:black;' onclick='showNoticeContent("
											...
											+ "</a></td><td>"
											+ data[i].upDateTime.split(' ')[0]+ "</td></tr>";
								}
